...
public class ScanQrActivity extends AppCompatActivity {
    ...
    private static final String BROKER_URL = "tcp://192.168.1.139:1883";
    ...
    private String qrCccdNumber12digit;
                        ...
                        if (currentEmbedding != null && nfcFaceEmbedding != null) {
                            ...
                            if (match) {
                                ...
                                runOnUiThread(() -> {
                                    ...
                                    Toast.makeText(this, "Khuôn mặt khớp với thẻ cccd, đang xác minh...", Toast.LENGTH_LONG).show();
                                });
                                Log.d("NFC", "CCCD number:"+  qrCccdNumber12digit);
                                verifyCCCD(qrCccdNumber12digit);
                            } else {
    ...
    private void readNfcWithMrz(Tag tag, String mrz) {
        ...
        nfcExecutor.execute(() -> {
            ...
            try {
                ...
                String documentNumberRaw12Digit = mrz.substring(15,27);
                String documentNumber12Digit = documentNumberRaw12Digit.replace("<", "");
                ...
                qrCccdNumber12digit = documentNumber12Digit;
                ...
                publishToMqtt(qrCccdNumber12digit, LocalDateTime.now(), "denied");
            } finally {
                try {
                        ...
                        if (regResponse.getErrCode() == 200 && regResponse.getData() != null && !regResponse.getData().isEmpty()) {
                            ...
                            if (qrRegistration.getStatus() == 1 && now.isAfter(startTime) && now.isBefore(endTime)) {
                                ...
                                runOnUiThread(() -> {
                                    ...
                                    Toast.makeText(ScanQrActivity.this, "Xác minh hợp lệ: " + purpose, Toast.LENGTH_LONG).show();
                                });
                            ...
                            Log.d("NFC", "Bạn chưa đăng ký, server trả về: "+ errorMessage);
                        }
                    } else {
